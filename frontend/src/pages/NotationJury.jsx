...
const MOCK_FILMS = {
  ...
  "3": {
    ...
    synopsis_original: "Un documentaire époustouflant qui suit le voyage d'un jeune réalisateur à travers les paysages les plus reculés de France, capturant la beauté brute de la nature et les histoires oubliées des derniers gardiens de ces terres sauvages.",
    synopsis_french: "A breathtaking documentary that follows a young filmmaker's journey through the most remote landscapes of France, capturing the raw beauty of nature and the forgotten stories of the last guardians of these wild lands.",
